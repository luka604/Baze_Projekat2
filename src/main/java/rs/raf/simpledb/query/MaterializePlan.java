...
import rs.raf.simpledb.record.TableInfo;
import rs.raf.simpledb.utils.Page;
...
public class MaterializePlan implements Plan {
   ...
   public int blocksAccessed() {
      ...
      double rpb = (double) (Page.BLOCK_SIZE / ti.recordLength());
   ...
   public Schema schema() {
	...
	public void printPlan(int indentLevel) {
		System.out.println("-".repeat(indentLevel)+"-> MATERIALIZATION OF ->");
		srcplan.printPlan(indentLevel+3);
