...
import rs.raf.simpledb.query.Predicate;
import rs.raf.simpledb.record.*;

/**
 * The scan class corresponding to the <i>Selection</i> relational
 * algebra operator.
 * All methods except next delegate their work to the
 * underlying scan.
 * @author Edward Sciore
 */
public class SelectionScan implements UpdateScan {
   private Scan s;
    ...
    */
   public SelectionScan(Scan s, Predicate pred) {
      this.s = s;
      this.pred = pred;
   }
