...
import rs.raf.simpledb.operators.*;
...
public class MultiBufferProductPlan implements Plan {
   ...
   /**
    * Creates a Cross-product plan for the specified queries.
   ...
   private TempTable copyRecordsFrom(Plan p) {
	...
	public void printPlan(int indentLevel) {
		System.out.println("-".repeat(indentLevel)+"-> MULTIBUFFER CROSS PRODUCT OF -> ");
